...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const pomodoroTimerInSeconds = 30;  // Define o tempo do Pomodoro em segundos
    ...
    const exercicios = [
        {name: 'Bridge', src: '/exercicios/alongamento_action/assets/bridge.gif'},
        {name: 'Extensão da Perna', src: '/exercicios/alongamento_action/assets/extensaoperna3.gif'},
        {name: 'Lombar Deitado', src: '/exercicios/alongamento_action/assets/lombardeitado.gif'},
        {name: 'Alongamento Coluna Lado', src: '/exercicios/alongamento_action/assets/alongamentocolunalado.gif'},
        {name: 'Alongamento Perna Trás', src: '/exercicios/alongamento_action/assets/alongamentopernatraz.gif'},
        {name: 'Alongamento Perna Frente', src: '/exercicios/alongamento_action/assets/alongamentopernafrente5.gif'},
        {name: 'Rotação', src: '/exercicios/alongamento_action/assets/rotacao.gif'},
        {name: 'Rotação Direita', src: '/exercicios/alongamento_action/assets/rotacaodireita.gif'},
        {name: 'Alongamento Ombro', src: '/exercicios/alongamento_action/assets/alongamentoombro.gif'},
        {name: 'Braço Baixo', src: '/exercicios/alongamento_action/assets/bracobaixo.gif'},
        {name: 'Alongamento Tríceps', src: '/exercicios/alongamento_action/assets/alongamentotriceps.gif'},
        {name: 'Braço Cima', src: '/exercicios/alongamento_action/assets/bracocima.gif'},
        {name: 'Coluna Sentado', src: '/exercicios/alongamento_action/assets/colunasentado3.gif'}
    ];
